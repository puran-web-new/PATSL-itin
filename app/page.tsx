        ...
        <div className="relative" style={{ width: 560, height: 560 }}>
          ...
          {SHOWCASE.map((card, i) => (
            <div
              ...
              style={{ '--offset': `${i * 120}deg`, '--radius': '220px' } as CSSProperties}
            >
              <div className="mrd-orbit-counter" style={{ '--offset': `${i * 120}deg` } as CSSProperties}>
                <RevealOnScroll delay={`${i * 140}ms`}>
                  <div
                    className="relative overflow-hidden rounded-[18px]"
                    style={{ width: 225, height: 172, boxShadow: '0 20px 50px rgba(0,0,0,.55)' }}
                  >
                    <RimRing
                    ...
                    />
                    <Image src={card.photo} alt={card.label} fill sizes="225px" className="object-cover" />
