...
export default function InvoicesPage() {
  ...
  return <AdminSidebarShell title="Invoices & payments" subtitle="Payment records and outstanding balances.">
    ...
    <div className="overflow-x-auto glass-card"><table className="w-full text-left text-xs"><thead className="bg-slate-50 text-[10px] uppercase text-slate-500"><tr><th className="px-4 py-3">Client</th><th className="px-4 py-3">Amount</th><th className="px-4 py-3">Status</th><th className="px-4 py-3">Created</th></tr></thead><tbody>
